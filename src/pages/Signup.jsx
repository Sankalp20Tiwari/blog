...
function Signup() {
  return (
    <div className='flex flex-col md:flex-row items-center justify-center min-h-screen bg-gray-100'>
      ...
      <div className='hidden md:flex flex-1 flex-col max-w-md px-4 md:px-6 text-gray-900'>
      ...
      <div className='flex-1 max-w-sm w-full p-4 md:p-6 bg-white shadow-lg rounded-lg flex justify-center items-center'>
        <SignupComponent />
      </div>
    </div>
  );
