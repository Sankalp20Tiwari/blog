...
function Home() {
    ...
    return (
        <div className='relative min-h-screen '> {/* Added pt-16 for consistent spacing */}
            {/* Hero Section */}
            <div className='relative'>
                <Container>
                    ...
                    <div className='relative z-10 text-center text-white pt-16'>
                        ...
                        {/* Show the button only if the user is not authenticated */}
                        {!authStatus ? (
                            <button 
                            ...
                            <div className='h-12' /> // Placeholder to maintain layout
                        )}
                    </div>
                </Container>
            </div>
            ...
            <div className='py-16 bg-gradient-to-r from-gray-900 to-gray text-center'>
                <Container>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
                        ...
                        <div className='p-6 bg-gradient-to-r from-gray-800 to-gray  rounded-lg shadow'>
                ...
                <Container>
                    ...
                    <div className='space-y-4'>
                        {[{
                            ...
                            <div key={index} className='p-4 bg-gradient-to-r from-gray-900 to-gray rounded-lg shadow'>
                                <div
